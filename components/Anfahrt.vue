...
<template>
  <div id="anfahrt" class="py-12 w-full bg-[#d6dbd4]">
    <h1 class="font-Lato text-3xl md:text-5xl text-center md:mb-12">Anfahrt</h1>
    <h3 class="font-Lato text-lg md:text-2xl text-center">So kommen Sie zu uns:</h3>
    <div class="flex md:flex-row flex-col justify-center justify-items-center md:py-5">
      <iframe
  ...
  <div>
    <div v-if="success" class="rounded bg-emerald-900 text-white text-lg p-4">
    ...
    >
      ...
      <div class="">
        <span class="inline-flex rounded-md shadow-sm">
          <button
            type="submit"
            class="inline-flex justify-center py-3 px-6 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-[#d28002] hover:bg-[#d28002] focus:outline-none focus:border-[#d28002] focus:shadow-outline-indigo active:bg-[#d28002] transition duration-150 ease-in-out"
          >
